...
See [architecture documentation](docs/architecture.md) for component relationships,
[interfaces](docs/interfaces.md) for the indexed service contracts, and
[operations](docs/operations.md) for local execution and configuration details.
